...
Time::Time() : Triad() {}//конструкторт за умовчанням 

Time::Time(double x, double y, double z, double r) : Triad(x, y, z, r) {} //конструктор ініціалізації 
...
Time* Time::operator - (Triad* D) {
	...
	T->SetX(this->GetX() - ((Triad*)D)->GetX());

	T->SetY(this->GetY() - ((Triad*)D)->GetY());

	T->SetZ(this->GetZ() - ((Triad*)D)->GetZ());
